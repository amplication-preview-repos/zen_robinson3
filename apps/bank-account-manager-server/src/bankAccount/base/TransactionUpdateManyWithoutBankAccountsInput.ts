...
@InputType()
class TransactionUpdateManyWithoutBankAccountsInput {
...
export { TransactionUpdateManyWithoutBankAccountsInput as TransactionUpdateManyWithoutBankAccountsInput };
