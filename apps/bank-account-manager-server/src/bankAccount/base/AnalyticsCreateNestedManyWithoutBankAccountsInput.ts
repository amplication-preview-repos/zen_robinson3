...
@InputType()
class AnalyticsCreateNestedManyWithoutBankAccountsInput {
...
export { AnalyticsCreateNestedManyWithoutBankAccountsInput as AnalyticsCreateNestedManyWithoutBankAccountsInput };
